...
public class NetworkTest2 {
    private static final Logger LOGGER = Logger.getLogger(NetworkTest2.class.getName());
...
//        LOGGER.debug(parser.serialize(new LobbyResponse(Lists.newArrayList(new Game("testomat",0,5, GameState.LOBBY,Configuration.DEFAULT)))));
        Message message = parser.deserialize("{'games':[{'name':'testomat','id':0,'currentPlayerCount':5,\"state\":\"LOBBY\",\"config\":{\"MAXPLAYERCOUNT\":0,\"HEIGHT\":0,\"WIDTH\":0,\"SHOTCOUNT\":0,\"HITPOINTS\":0,\"SUNKPOINTS\":0,\"ROUNDTIME\":0,\"VISUALIZATIONTIME\":0,\"SHIPS\":{\"1\":{\"position\":[{\"x\":1,\"y\":2}]}},\"PENALTYMINUSPOINTS\":1,\"PENALTYTYPE\":\"POINTLOSS\"},\"tournament\":false}],\"messageId\":251}");
